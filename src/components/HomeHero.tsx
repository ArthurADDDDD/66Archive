        ...
        @media (hover: none) and (pointer: coarse) and (min-width: 768px) and (max-width: 1366px) {
          .home-hero__glow--right {
            background: radial-gradient(
              circle at 50% 50%,
              rgba(91, 200, 232, 0.11) 0%,
              rgba(91, 200, 232, 0.07) 34%,
              rgba(91, 200, 232, 0.028) 56%,
              rgba(91, 200, 232, 0) 78%
            ) !important;
          ...
          .home-hero__glow--left {
            background: radial-gradient(
              circle at 50% 50%,
              rgba(229, 86, 138, 0.10) 0%,
              rgba(229, 86, 138, 0.058) 36%,
              rgba(229, 86, 138, 0.022) 58%,
              rgba(229, 86, 138, 0) 80%
            ) !important;
            filter: none !important;
          }
        }
