...
export function ActivityStrip({
  ...
  return (
    ...
    >
      ...
      {/* 只报活跃年份，不再并一个「· N 期」：调用方自己那一行已经写过期数，
          条形本身也已经把分布画出来了，数字在这里是第三遍。 */}
      <span className="min-w-0 text-right font-mono text-meta text-ink tnum">{years}</span>
    </div>
  )
}
