  ...
  },
  {
    ...
    beats: [
      ...
      },
      {
        ...
        kicker: '大周史超长 Boss 战',
        title: '科目二，通过！！！',
        body: '多年连续剧，大周史的主线 Boss。失败、再考、失败、继续考，这一次终于打完了——6 月 13 日早上，她在微博晒出科目二 100 分：过了。第二天的心灵砒霜标题是：每天醒来都要确认下是不是真的过了科目二。',
...
export const HIGHLIGHTS: Highlight[] = [
  ...
  },
  {
    ...
    kicker: '大周史主线 Boss',
    title: '科目二，通过！！！',
    body: '多年连续剧，大周史的主线 Boss。2020 年 6 月 13 日终于过了，第二天的心灵砒霜标题是：每天醒来都要确认下是不是真的过了科目二。',
    emphasis: '2020',
    category: 'daily-meme',
  },
  {
