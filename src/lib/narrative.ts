 ...
 * - ACT II 2015-01 ~ 2023-11-30：156277 直播间那些年。当前最早可确认的直播录像是 2015-01-21，
 *   但这只是现存档案锚点，不等于首场日期已经确定：01-21 录像评论区有“第一场”说法，
 *   01-22 的 AcFun 录像标题又写“斗鱼首秀”，因此首场具体是哪一天仍不下结论。
 ...
 * 第一次上传→2010-05-08 / 越来越多人→2010-06-30 / 开始直播→2015-01-21（现存最早录像锚点，不代表首场日期）；
 ...
 *   百度百科记 2015-01-21 在斗鱼开设房间（仅作来源记录，不据此认定首场日）；2015-07-05 起每周日直播《心灵砒霜》。
...
export const STORY_ACTS: Act[] = [
  {
    ...
    beats: [
      ...
      },
      {
        ...
        // （B 站「[1.21直播录像]」，人工复核评论区也能看到把它称作“第一场”的说法；
        // 百度百科与 nvliu.me 还把 1/21 记作开设房间 / 首播）；1/22 的 AcFun 录像标题却写「斗鱼首秀」；
        // 1/24 是 1/21 那场优酷版本的上传日。几种口径不能压成一个「唯一首播日」，所以主卡只写到月。
        target: { kind: 'entry', id: '2015-01-21-live-01' },
      },
      {
        id: 'names',
