...
export const GAP_NOTES: GapNote[] = [
  ...
  },
  {
    ...
    kind: 'gap',
    known: '目前没有找到早于 01-21 的直播录像。01-21 与 01-22 都有录像，但「第一场到底是哪天」还不能定论。',
    guess: '这段空白既不能证明当时一定没播，也不能反过来用它推定首播日期。',
    wanted: '2015 年 1 月的斗鱼开播公告、房间记录、微博 / 贴吧开播记录，或能定位时间的截图。',
  },
  {
    id: '2015-04',
    from: '2015-04',
    ...
    label: '2015-04',
    kind: 'gap',
    known: '已经找到《2015.4 女流 背部直播》（BV1Mo4y1h7Jn，93 分钟），但只能定位到月份，写不出具体是哪一天。',
    guess: '这一格是空的，原因是日期未定而不是录像不存在——档案宁可留空，也不把猜的日期写进去。',
    wanted: '能证明这段录像具体直播日期的标题、水印、评论、帖子或原始文件名。',
  },
  {
    id: '2015-05',
    from: '2015-05',
  ...
  },
  {
    ...
    label: '2020 的三个缺档直播日',
    kind: 'gap',
    known: '贴吧日志可以确认 03-05（聊天）、08-18（唱歌）、09-21（唱歌）当天开播，但档案里没有对应录像。',
    wanted: '这三天的完整录播、斗鱼回放 ID 或私人录像。',
  },
  {
    id: 'douyu-stop-tail',
    from: '2024-04',
    ...
    kind: 'known',
    known:
      '斗鱼直播在 2023 年 11 月 30 日之后没有再更新；2023-12 到 2024-03 之间，B 站还留下过几场零星的「夜话 / 话疗」直播（2023-12-20、12-21，2024-01-10 两场、01-27、02-29、03-03），不是完全空白。真正没有任何记录的是 2024 年 4 — 7 月，直到 2024 年 8 月 18 日抖音复播。',
  },
]
