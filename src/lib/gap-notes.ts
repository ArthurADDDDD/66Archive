 ...
 * 档案空白的已知原因。
 *
 * 内容来自 `data/reports/missing-resources.md`（2026-08-26 版审计，视频时期一条已按 2026-09-20 的 task-035 更新，2015-05 与 2016-02 两条已按 2026-09-23 的 task-041 续五更新，2015-05 又按同日 task-044 更新）——那份表是对外征集缺失资源的入口，
...
export const GAP_NOTES: GapNote[] = [
  ...
  },
  {
    ...
    label: '2015-05',
    kind: 'gap',
    known: '上旬没有开播：直播间快照从 04-30 之后一直停到 05-10，同期吧友说她去了日本。05-14 晚贴吧有人实时发帖说她正在播《雷曼传奇》，05-15 的直播间快照也是雷曼，05-21 也有吧友看到她在播；另有一段 124 分钟的雷曼录像只能定在 05-10 到 05-13 之间。除此之外仍没有找到录像。',
