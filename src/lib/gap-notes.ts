...
export const GAP_NOTES: GapNote[] = [
  ...
  },
  {
    ...
    label: '2016-02',
    kind: 'known',
    known: '已经确认 02-02《勇者斗恶龙：建造者》、02-19《毛线小精灵 UNRAVEL》、02-21《心灵砒霜》与 02-24 四天。春节停播有直播间快照为证：02-02 下播后标题改成「开开心心回家过年」，下一次开播是 02-17。',
    guess: '02-17 到 02-21 之间还有一段《终极街霸4》录像，具体哪天还没定。',
  },
  {
