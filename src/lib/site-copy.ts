...
export const SITE_COPY: SiteCopy = {
  ...
  texts: [
    ...
    { id: 'gallery-tab-live', group: '画廊', label: '切换 · 全直播合集', vars: ['count'], text: '全直播合集 · {count}' },
    { id: 'gallery-live-intro', group: '画廊', label: '全直播合集 · 图墙上方的一句说明', vars: ['count', 'from', 'to'], text: '从 {from} 到 {to}，有画面的 {count} 场直播各截一帧，按时间排成一整面墙。不挑好看的，只看那天在干什么；悬停或轻点一格看是哪一天。' },
    { id: 'gallery-live-note', group: '画廊', label: '全直播合集 · 图墙下方的注脚', text: '画面取自录像中段；截不到画面的用录像封面代替，连封面都没有的场次不收进来。' },
