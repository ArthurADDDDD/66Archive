...
export const SITE_COPY: SiteCopy = {
  ...
  pages: [
    ...
    },
    {
      ...
      title: '这份档案不是一个人攒出来的。',
      lede: [
        '最开始只是想帮忙收集一些老录播——尤其是那些不太好找的场次，然后一场一场打上具体的标签。这样想看录播的时候，直接搜游戏名就能找到当年那一场，这样大家就不用在老录播里一个个翻日期（来源比较散，命名比较不好找，有的只有日期就需要人工来核对）。',
        '就这样，大概的雏形就有了。后来想着来都来了，不如顺手把这些年发生的大伙儿印象深刻的事情也给捋一捋，于是就动手做了。',
        '不过个人的能力很有限，好多东西没嘛印象了，而且15 到 20 年那几年我在念书，也算听姐姐的话，有好好在学习，所以直播看得不算太多，不过砒霜应该没落下太多（感恩66劝学，感恩心灵砒霜）。所以站里的内容一定有缺、有错，这是实话。',
