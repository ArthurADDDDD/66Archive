...
export type SiteCopyBlock = {
  ...
  lede: string
  /**
   * 整块不显示（后台可切换）。和「把三段文字都清空」不同：文字留着，
   * 随时可以再打开。目前只有支持整块隐藏的区块会读它（联系页「关于本站」）。
   */
  hidden?: boolean
}
...
export const SITE_COPY: SiteCopy = {
  ...
  texts: [
    ...
    { id: 'gallery-chronicle-link', group: '画廊', label: '右上角链接', text: '去大事件 →' },
    { id: 'gallery-summary', group: '画廊', label: '页头下方的一句', vars: ['featured', 'all', 'live', 'from', 'to'], text: '{featured} 张纪念节点，{all} 张全量影像，{live} 张视频与直播画面，跨 {from}–{to} 年。' },
    ...
    { id: 'gallery-tab-live', group: '画廊', label: '切换 · 超级大合集', vars: ['count'], text: '全直播合集 · {count}' },
    { id: 'gallery-live-intro', group: '画廊', label: '超级大合集 · 图墙上方的一句说明', vars: ['count', 'from', 'to'], text: '从 {from} 到 {to}，视频时代的每一支视频、此后的每一场直播，各取一帧，一共 {count} 张，按时间排成一整面墙。不挑好看的，只看那天在干什么；悬停或轻点一格看是哪一天。' },
    { id: 'gallery-live-note', group: '画廊', label: '超级大合集 · 图墙下方的注脚', text: '直播取录像中段的画面，截不到的用录像封面代替；视频时代的投稿用视频封面。连封面都没有的不收进来。' },
    ...
    { id: 'gallery-year-link', group: '画廊', label: '每一年右侧的链接', text: '这一年的大事件 →' },
    ...
    { id: 'game-chronicle-cta', group: '游戏详情页', label: '场次列表下方的按钮', text: '在大事件里查看全部相关记录' },
    ...
    { id: 'chronicle-year-empty', group: '大事件', label: '这一年一条记录都没有时', text: '这一年暂时还没找到能确认的记录。' },
    { id: 'chronicle-year-count', group: '大事件', label: '这一年没有节点、但有录像时', vars: ['count'], text: '这一年留下了 {count} 条记录。' },
    { id: 'chronicle-year-archive', group: '大事件', label: '上一句后面的链接', text: '去录播室看看 →' },
    { id: 'chronicle-open-archive', group: '大事件', label: '每一年末尾的按钮', vars: ['count'], text: '看这一年的全部 {count} 条记录' },
    { id: 'chronicle-milestone', group: '大事件', label: '重要节点的标记', text: '关键节点' },
    { id: 'chronicle-activity-note', group: '大事件', label: '期数小图右上角的说明', text: '按当前档案收录期数' },
    { id: 'chronicle-footer-hint', group: '大事件', label: '页尾提示（{link} 是下一条的链接）', vars: ['link'], text: '想找具体日期、游戏或来源，可以去 {link}。' },
    { id: 'chronicle-footer-link', group: '大事件', label: '页尾提示里的链接文字', text: '录播室' },
    ...
    { id: 'contact-chronicle-link', group: '联系页', label: '底部按钮 · 大事件', text: '前往大事件' },
