...
> **2026-08-29 状态更新：** 本节当时列出的 Escape Cube / Rusty Lake Hotel 已确认是预录视频而非直播候选；`2020-03-05`、`2020-08-18`、`2020-09-21` 已找回完整录播并入库，同时补入此前未列出的 `2020-11-25`。下文数字与结论仍是 Task 031 完成时的历史快照。
